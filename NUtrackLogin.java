...
public class NUtrackLogin {
    ...
    public static void LoginPage() {
        ...
        JLabel background1 = new JLabel(new ImageIcon("NUTrackbglogin.png"));
        background1.setBounds(0, 0, 1920, 1080);
        LoginPanel.add(background1);

        // NUTrack Logo
        ImageIcon NUTrackLogo = new ImageIcon("NUTrackLogobgremove.png");
        Image img = NUTrackLogo.getImage().getScaledInstance(500, 300, Image.SCALE_SMOOTH);
        JLabel logoLabel = new JLabel(new ImageIcon(img));
        logoLabel.setBounds(1245, 200, 500, 300);
        ...
        usernameinput.setForeground(Color.DARK_GRAY);

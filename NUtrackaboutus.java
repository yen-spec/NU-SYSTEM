...
public class NUtrackaboutus {
    ...
    public static void AboutUsPage() {
        ...
        JLabel background1 = new JLabel(new ImageIcon("NUTrackbgaboutus2.png"));
        background1.setBounds(0, 0, 1920, 1080);
        AboutusPanel.add(background1);

        // NU Logo
        ImageIcon NULogo = new ImageIcon("nulogo2.png");
        Image img = NULogo.getImage().getScaledInstance(180, 190, Image.SCALE_SMOOTH);
        JLabel logoLabel = new JLabel(new ImageIcon(img));
        logoLabel.setBounds(870, 60, 180, 190);
        AboutusPanel.add(logoLabel);

        // NU Track Logo
        ImageIcon NUTrackLogo = new ImageIcon("NUTrackLogobgremove.png");
        Image img2 = NUTrackLogo.getImage().getScaledInstance(680, 400, Image.SCALE_SMOOTH);
        JLabel logoLabel2 = new JLabel(new ImageIcon(img2));
        logoLabel2.setBounds(630, 240, 680, 400);
        ...
        textLabel.setBounds(420, 490, 1100, 120);
        ...
        devLabel.setBounds(420, 780, 1100, 120);
